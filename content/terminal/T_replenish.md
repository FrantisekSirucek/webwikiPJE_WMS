...
<a href="" data-bs-toggle="modal" data-bs-target="#imageModal" onclick="showImage('/content/terminal/images/Strihani/strihani_dlazdice.png')">
...
<a href="" data-bs-toggle="modal" data-bs-target="#imageModal" onclick="showImage('/content/terminal/images/Strihani/strihani_start.png')">
...
<a href="" data-bs-toggle="modal" data-bs-target="#imageModal" onclick="showImage('/content/terminal/images/Strihani/strihani_nacten_material.png')">
    <img src="/content/terminal/images/Strihani/strihani_nacten_material.png" alt="načten materiál" width="900" />
</a>

<a href="" data-bs-toggle="modal" data-bs-target="#imageModal" onclick="showImage('/content/terminal/images/Strihani/strihani_nacten_lokace.png')">
...
<a href="" data-bs-toggle="modal" data-bs-target="#imageModal" onclick="showImage('/content/terminal/images/Strihani/strihani_zadani.png')">
