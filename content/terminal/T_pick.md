...
U **Multipick** zezelanají načtené joby a dokud nemám vybrané všechny co chci pokračuji v načítání. Až jsem spokojený, tak kliknu na zelené tlačítko <span style="backround-color:rgb(3, 201, 3) color:rgb(248, 252, 249);"><strong>Začít</strong></span>
...
Ve spodní části vydím, kolik metrů a na jakém bubnu zbyde. V případě potřebu může některé údaje změnit. 
<a href="#" data-bs-toggle="modal" data-bs-target="#imageModal" onclick="showImage('/content/images/doklady/doklady-prijemky.png')">
...
Když jsou všechny položky vypickované, čtečka nás vyzve k odložení materiáů na lokaci výdeje a k jejímu načtení. 
<a href="#" data-bs-toggle="modal" data-bs-target="#imageModal" onclick="showImage('/content/images/doklady/doklady-prijemky.png')">
    <img src="/content/terminal/images/Pick/pick_konec_scan_vydej.png" alt="NačtiJoby" width="900" />
</a>

Pokud všechno proběhlo v pořádku, systém nám zobrazí zelenou hlášku <span style:="color:rgb(39, 78, 2); backround-color:rgb(186, 245, 131) "><strong>OK</strong></span>
